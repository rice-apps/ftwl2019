...
<p><b>Hoot, Hoot, Hooray</b><br></br>
    ...
    <p>What we provide:
    Party Host, decorations, craft/activity, and a special gift for the birthday child.</p>

    <p>What you provide:
    Refreshments (snacks, drinks, cake). Please note that there is no refrigerator or stove available. Local pizza may be ordered and delivered to 29816 Dobbin Hufsmith, Magnolia, 77354</p>

    <p>Pricing:
    $300 - limit 15 children including siblings, $10 per additional child, maximum 25 children. Guest limit 35 (includes both children and parents)</p>

    <p>$100 deposit: $50 to hold date and $50 security desposit.
    Balance due before party begins.</p>

    <p>Scheduling:
    Party times are 10:00 a.m., 1:00 p.m. and 4:00 p.m. on Saturdays.
    Fridays 4:00 p.m. only.</p>
  ...
  <div class="right">
    <Box>
        <h2><Image src={'../static/party/1.png'} sx={{width: ['800px', '800px']}} padding="20px"/></h2>
    </Box>
    <Box>
      <ColoredCard cardwidth="300px" lettersize1= "20px" lettersize2= "20px" cardcolor="orange" line1text="CALL US" line2text="281-259-0039"></ColoredCard>
      <br></br>
      <ColoredCard cardwidth="300px" lettersize1= "20px" lettersize2= "20px" cardcolor="orange" line1text="EMAIL US" line2text="ftwl.education@gmail.com"></ColoredCard>
    </Box>
  </div>
