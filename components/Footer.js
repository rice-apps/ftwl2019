            ...
            <Flex>
                <Box p={5} fontSize={2} width={[(1 / 2), (1 / 2), (1 / 2)]} color='white' bg='green'>
                    ...
                    <p>Friends of Texas Wildlife is a 501(c)(3) non-profit organization;
                        100% of all donations support native Texas wildlife and are tax deductible to
                ...
                <Box p={5} fontSize={2} width={[1, 1, 1]} color='white' bg='green'>
                    <Flex>
                        <Box p={5} fontSize={2} width={[1, 1, 1]} color='white' bg='green' padding='10px 20px 10px 20px'>
                            About Us
            </Box>
                        <Box p={5} fontSize={2} width={[1, 1, 1]} color='white' bg='green' padding='10px 20px 10px 20px'>
                            Ways to Give
